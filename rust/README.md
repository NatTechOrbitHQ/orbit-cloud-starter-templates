...
Minimal Rust starter for Orbit Cloud. Deploys with zero configuration: connect the repo
...
a `rust-toolchain.toml` file. Generic pins in `.tool-versions` or `mise.toml` also work. Declare the
