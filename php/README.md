...
Minimal PHP starter for Orbit Cloud. Deploys with zero configuration: connect the repo
...
the `php` requirement in composer.json. Generic pins in `.tool-versions` or `mise.toml` also work. Declare the
