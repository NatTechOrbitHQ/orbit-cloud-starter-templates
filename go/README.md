...
Minimal Go starter for Orbit Cloud. Deploys with zero configuration: connect the repo
...
the `go` directive in go.mod. Generic pins in `.tool-versions` or `mise.toml` also work. Declare the
